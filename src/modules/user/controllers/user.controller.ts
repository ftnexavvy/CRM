...
export class UserController {
  ...
  @Get(":id/login-history") @ApiOperation({ summary: "View employee login and logout history" }) async loginHistory(@CurrentUser() user: AuthUser, @Param("id") id: string) { return this.ok("Login history retrieved successfully", await this.service.getLoginHistory(user.companyId, id)); }
