    ...
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: (configService) => ({ secret: configService.getOrThrow("JWT_SECRET") }),
            }),
        ],
        ...
        providers: [
            ...
            { provide: auth_repository_interface_1.AUTH_REPOSITORY, useExisting: auth_repository_1.AuthRepository },
